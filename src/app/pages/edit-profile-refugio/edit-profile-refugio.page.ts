...
@Component({
  selector: 'app-edit-profile-refugio',
  templateUrl: './edit-profile-refugio.page.html',
  styleUrls: ['./edit-profile-refugio.page.scss'],
})
export class EditProfileRefugioPage implements OnInit {
  ...
  async submitForm(){
    ...
    this.authService.updaterefugio(this.form.value).subscribe((user: User) => {
